"""
Django settings for muddy_sky_42514 project.
...
ROOT_URLCONF = 'muddy_sky_42514.urls'
...
WSGI_APPLICATION = 'muddy_sky_42514.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_sky_42514 API",
    "DESCRIPTION": "API documentation for muddy_sky_42514 App",
    "VERSION": "v1",
}
